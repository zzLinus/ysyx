...
static struct expr *rewrite_m(struct expr *e)
{
  ...
  switch (e->type)
  {
    case E_NOT: e->left.expr = rewrite_m(e->left.expr); break;
    case E_OR:
    case E_AND:
...
void menu_finalize(struct menu *parent)
{
  ...
  {
    sym->rev_dep.expr =
        expr_alloc_or(sym->rev_dep.expr, expr_alloc_and(parent->prompt->visible.expr, expr_alloc_symbol(&symbol_mod)));
  }
}
