  ...
  for_all_symbols(i, sym)
  {
    ...
    switch (sym->type)
    {
      ...
      case S_STRING:
        ...
        /* fall through */
      default: sym->def[def].val = NULL; sym->def[def].tri = no;
    }
  }
...
static void header_print_symbol(FILE *fp, struct symbol *sym, const char *value, void *arg)
{
  switch (sym->type)
  {
    ...
    case S_TRISTATE:
    {
      ...
      switch (*value)
      {
        ...
        case 'm':
          suffix = "_MODULE";
          /* fall through */
        default: fprintf(fp, "#define %s%s%s 1\n", CONFIG_, sym->name, suffix);
      }
      break;
    }
    case S_HEX:
    ...
    case S_STRING:
    case S_INT: fprintf(fp, "#define %s%s %s\n", CONFIG_, sym->name, value); break;
    default: break;
  }
}
...
static void conf_write_symbol(FILE *fp, struct symbol *sym, struct conf_printer *printer, void *printer_arg)
{
  ...
  switch (sym->type)
  {
    ...
    case S_STRING:
      ...
      free((void *)str);
      break;
    default: str = sym_get_string_value(sym); printer->print_symbol(fp, sym, str, printer_arg);
  }
}
  ...
  for_all_symbols(i, sym)
  {
    ...
    switch (sym_get_type(sym))
    {
      ...
      case S_TRISTATE:
        ...
        switch (mode)
        {
          case def_yes: sym->def[S_DEF_USER].tri = yes; break;
          case def_mod: sym->def[S_DEF_USER].tri = mod; break;
          case def_no:
