...
void sym_calc_value(struct symbol *sym)
{
  ...
  switch (sym->type)
  {
    case S_INT:
    case S_HEX:
    case S_STRING: newval = symbol_empty.curr; break;
    case S_BOOLEAN:
    case S_TRISTATE: newval = symbol_no.curr; break;
    default:
...
tristate sym_toggle_tristate_value(struct symbol *sym)
{
  ...
  do
  {
    switch (newval)
    {
      case no: newval = mod; break;
      case mod: newval = yes; break;
      case yes: newval = no; break;
    }
...
bool sym_string_within_range(struct symbol *sym, const char *str)
{
  ...
  switch (sym->type)
  {
    ...
    case S_TRISTATE:
      ...
      {
        case 'y':
        case 'Y': return sym_tristate_within_range(sym, yes);
        case 'm':
        case 'M': return sym_tristate_within_range(sym, mod);
        case 'n':
        case 'N': return sym_tristate_within_range(sym, no);
      }
      return false;
    default: return false;
  }
...
bool sym_set_string_value(struct symbol *sym, const char *newval)
{
  ...
  switch (sym->type)
  {
    ...
    case S_TRISTATE:
      ...
      {
        case 'y':
        case 'Y': return sym_set_tristate_value(sym, yes);
        case 'm':
        case 'M': return sym_set_tristate_value(sym, mod);
        case 'n':
        case 'N': return sym_set_tristate_value(sym, no);
      }
      return false;
    default:;
  }
...
const char *sym_get_string_default(struct symbol *sym)
{
  ...
  switch (sym->type)
  {
    ...
    case S_INT:
    case S_HEX: return str;
    case S_STRING: return str;
...
const char *sym_get_string_value(struct symbol *sym)
{
  ...
  switch (sym->type)
  {
    ...
    case S_TRISTATE:
      ...
      {
        case no: return "n";
        case mod: sym_calc_value(modules_sym); return (modules_sym->curr.tri == no) ? "n" : "m";
        case yes: return "y";
      }
      break;
    default:;
