...
VL_ATTR_COLD void Vtop___024root___configure_coverage(Vtop___024root* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[347]), first, "vsrc/alu.v", 77, 10, ".top.alu", "v_line/alu_4bit", "case", "77-81");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[348]), first, "vsrc/alu.v", 84, 4, ".top.alu", "v_branch/alu_4bit", "if", "84-85");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[349]), first, "vsrc/alu.v", 84, 5, ".top.alu", "v_branch/alu_4bit", "else", "87");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[350]), first, "vsrc/alu.v", 83, 10, ".top.alu", "v_line/alu_4bit", "case", "83,88-90");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[351]), first, "vsrc/alu.v", 93, 4, ".top.alu", "v_branch/alu_4bit", "if", "93-94");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[352]), first, "vsrc/alu.v", 93, 5, ".top.alu", "v_branch/alu_4bit", "else", "96");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[353]), first, "vsrc/alu.v", 92, 10, ".top.alu", "v_line/alu_4bit", "case", "92,97-99");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[354]), first, "vsrc/alu.v", 101, 3, ".top.alu", "v_line/alu_4bit", "case", "101-105");
