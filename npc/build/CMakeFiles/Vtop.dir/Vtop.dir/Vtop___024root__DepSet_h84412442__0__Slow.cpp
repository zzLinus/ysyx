...
VL_ATTR_COLD void Vtop___024root___configure_coverage(Vtop___024root* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[346]), first, "vsrc/alu.v", 44, 24, ".top.alu", "v_line/alu_4bit", "block", "44");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[347]), first, "vsrc/alu.v", 49, 10, ".top.alu", "v_line/alu_4bit", "case", "49-53");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[348]), first, "vsrc/alu.v", 55, 10, ".top.alu", "v_line/alu_4bit", "case", "55-59");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[349]), first, "vsrc/alu.v", 61, 10, ".top.alu", "v_line/alu_4bit", "case", "61-65");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[350]), first, "vsrc/alu.v", 67, 10, ".top.alu", "v_line/alu_4bit", "case", "67-71");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[351]), first, "vsrc/alu.v", 73, 10, ".top.alu", "v_line/alu_4bit", "case", "73-77");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[352]), first, "vsrc/alu.v", 79, 10, ".top.alu", "v_line/alu_4bit", "case", "79-83");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[353]), first, "vsrc/alu.v", 86, 4, ".top.alu", "v_branch/alu_4bit", "if", "86-87");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[354]), first, "vsrc/alu.v", 86, 5, ".top.alu", "v_branch/alu_4bit", "else", "89");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[355]), first, "vsrc/alu.v", 85, 10, ".top.alu", "v_line/alu_4bit", "case", "85,90-92");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[356]), first, "vsrc/alu.v", 95, 4, ".top.alu", "v_branch/alu_4bit", "if", "95-96");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[357]), first, "vsrc/alu.v", 95, 5, ".top.alu", "v_branch/alu_4bit", "else", "98");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[358]), first, "vsrc/alu.v", 94, 10, ".top.alu", "v_line/alu_4bit", "case", "94,99-101");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[359]), first, "vsrc/alu.v", 103, 3, ".top.alu", "v_line/alu_4bit", "case", "103-107");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[360]), first, "vsrc/alu.v", 46, 1, ".top.alu", "v_line/alu_4bit", "block", "46-48");
