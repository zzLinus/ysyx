    ...
    if ((0U != (IData)(vlSelf->top__DOT__lookup__DOT__ascii))) {
        if (VL_UNLIKELY((0xa9U == (IData)(vlSelf->top__DOT__lookup__DOT__ascii)))) {
            vlSelf->top__DOT__my_vmem__DOT__word_count 
                = (0xfffU & ((IData)(1U) + VL_DIV_III(12, (IData)(vlSelf->top__DOT__my_vmem__DOT__word_count), (IData)(0x46U))));
            vlSelf->top__DOT__my_vmem__DOT__word_count 
                = (0xfffU & ((IData)(0x46U) * (IData)(vlSelf->top__DOT__my_vmem__DOT__word_count)));
