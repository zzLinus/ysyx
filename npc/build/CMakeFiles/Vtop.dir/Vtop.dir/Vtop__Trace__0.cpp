...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+39,(vlSelf->seg_x),3);
    bufp->chgCData(oldp+40,(vlSelf->alu_fnselec),3);
    bufp->chgCData(oldp+41,(vlSelf->alu_a),4);
    bufp->chgCData(oldp+42,(vlSelf->alu_b),4);
    bufp->chgBit(oldp+43,(vlSelf->counter_EN));
    bufp->chgBit(oldp+44,(vlSelf->en));
    bufp->chgBit(oldp+45,(vlSelf->ec_en));
    bufp->chgCData(oldp+46,(vlSelf->s),2);
    bufp->chgSData(oldp+47,(vlSelf->ledr),16);
    bufp->chgBit(oldp+48,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+49,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+50,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+51,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+52,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+53,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+54,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+55,(vlSelf->seg0),8);
    bufp->chgCData(oldp+56,(vlSelf->seg1),8);
    bufp->chgCData(oldp+57,(vlSelf->seg2),8);
    bufp->chgCData(oldp+58,(vlSelf->seg3),8);
    bufp->chgCData(oldp+59,(vlSelf->seg4),8);
    bufp->chgCData(oldp+60,(vlSelf->seg5),8);
    bufp->chgCData(oldp+61,(vlSelf->seg6),8);
    bufp->chgCData(oldp+62,(vlSelf->seg7),8);
    bufp->chgCData(oldp+63,(vlSelf->y),2);
    bufp->chgCData(oldp+64,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+65,(vlSelf->y_dec),8);
    bufp->chgCData(oldp+66,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+67,(vlSelf->alu_zero));
    bufp->chgBit(oldp+68,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+69,(vlSelf->alu_carry));
    bufp->chgCData(oldp+70,(vlSelf->inc_counter_out),3);
    bufp->chgCData(oldp+71,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+72,(vlSelf->timer_out));
    bufp->chgBit(oldp+73,((1U & (~ (IData)(vlSelf->rst)))));
}
