...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+67,(vlSelf->inc_counter_out),8);
    bufp->chgCData(oldp+68,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+69,(vlSelf->timer_out));
    bufp->chgCData(oldp+70,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+71,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
