...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+36,(vlSelf->s),2);
    bufp->chgSData(oldp+37,(vlSelf->ledr),16);
    bufp->chgBit(oldp+38,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+39,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+40,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+41,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+42,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+43,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+44,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+45,(vlSelf->seg0),8);
    bufp->chgCData(oldp+46,(vlSelf->seg1),8);
    bufp->chgCData(oldp+47,(vlSelf->seg2),8);
    bufp->chgCData(oldp+48,(vlSelf->seg3),8);
    bufp->chgCData(oldp+49,(vlSelf->seg4),8);
    bufp->chgCData(oldp+50,(vlSelf->seg5),8);
    ...
    bufp->chgBit(oldp+58,((1U & (IData)(vlSelf->seg_x))));
    bufp->chgBit(oldp+59,((1U & (~ (IData)(vlSelf->rst)))));
}
