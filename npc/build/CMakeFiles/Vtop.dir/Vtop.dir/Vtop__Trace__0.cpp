...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+30,(vlSelf->x),3);
    bufp->chgCData(oldp+31,(vlSelf->ec_x),4);
    bufp->chgBit(oldp+32,(vlSelf->en));
    bufp->chgBit(oldp+33,(vlSelf->ec_en));
    bufp->chgCData(oldp+34,(vlSelf->s),2);
    bufp->chgSData(oldp+35,(vlSelf->ledr),16);
    bufp->chgBit(oldp+36,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+37,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+38,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+39,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+40,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+41,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+42,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+43,(vlSelf->seg0),8);
    bufp->chgCData(oldp+44,(vlSelf->seg1),8);
    bufp->chgCData(oldp+45,(vlSelf->seg2),8);
    bufp->chgCData(oldp+46,(vlSelf->seg3),8);
    bufp->chgCData(oldp+47,(vlSelf->seg4),8);
    bufp->chgCData(oldp+48,(vlSelf->seg5),8);
    bufp->chgCData(oldp+49,(vlSelf->seg6),8);
    bufp->chgCData(oldp+50,(vlSelf->seg7),8);
    bufp->chgCData(oldp+51,(vlSelf->y),2);
    bufp->chgCData(oldp+52,(vlSelf->ec_y),2);
    bufp->chgCData(oldp+53,(vlSelf->y_dec),8);
    bufp->chgIData(oldp+54,(vlSelf->top__DOT__dec__DOT__i),32);
    bufp->chgIData(oldp+55,(vlSelf->top__DOT__encoder__DOT__unnamedblk1__DOT__i),32);
    bufp->chgBit(oldp+56,((1U & (~ (IData)(vlSelf->rst)))));
}
