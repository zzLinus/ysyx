...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+44,(vlSelf->ec_en));
    bufp->chgCData(oldp+45,(vlSelf->s),2);
    bufp->chgIData(oldp+46,(vlSelf->sft_rgtr_data),32);
    bufp->chgCData(oldp+47,(vlSelf->sft_rgtr_shamt),5);
    bufp->chgBit(oldp+48,(vlSelf->sft_rgtr_l_or_r));
    bufp->chgBit(oldp+49,(vlSelf->sft_rgtr_a_or_l));
    bufp->chgSData(oldp+50,(vlSelf->ledr),16);
    bufp->chgBit(oldp+51,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+52,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+53,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+54,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+55,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+56,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+57,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+58,(vlSelf->seg0),8);
    bufp->chgCData(oldp+59,(vlSelf->seg1),8);
    bufp->chgCData(oldp+60,(vlSelf->seg2),8);
    bufp->chgCData(oldp+61,(vlSelf->seg3),8);
    bufp->chgCData(oldp+62,(vlSelf->seg4),8);
    bufp->chgCData(oldp+63,(vlSelf->seg5),8);
    bufp->chgCData(oldp+64,(vlSelf->seg6),8);
    bufp->chgCData(oldp+65,(vlSelf->seg7),8);
    bufp->chgIData(oldp+66,(vlSelf->sft_out_q),32);
    bufp->chgCData(oldp+67,(vlSelf->y),2);
    bufp->chgCData(oldp+68,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+69,(vlSelf->y_dec),8);
    bufp->chgCData(oldp+70,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+71,(vlSelf->alu_zero));
    bufp->chgBit(oldp+72,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+73,(vlSelf->alu_carry));
    bufp->chgCData(oldp+74,(vlSelf->inc_counter_out),8);
    bufp->chgCData(oldp+75,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+76,(vlSelf->timer_out));
    bufp->chgCData(oldp+77,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+78,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+79,((0xfU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgCData(oldp+80,((0xfU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgBit(oldp+81,((1U & (~ (IData)(vlSelf->rst)))));
}
