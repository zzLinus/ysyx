...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+88,(vlSelf->top__DOT__timer_1s__DOT__count_clk),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgCData(oldp+89,(vlSelf->top__DOT__state_machine__DOT__state_dout),4);
        bufp->chgBit(oldp+90,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__lut_out));
        bufp->chgBit(oldp+91,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__hit));
    }
    bufp->chgBit(oldp+92,(vlSelf->clk));
    bufp->chgBit(oldp+93,(vlSelf->rst));
    bufp->chgCData(oldp+94,(vlSelf->sw),8);
    bufp->chgBit(oldp+95,(vlSelf->ps2_clk));
    bufp->chgBit(oldp+96,(vlSelf->ps2_data));
    bufp->chgCData(oldp+97,(vlSelf->a),8);
    bufp->chgCData(oldp+98,(vlSelf->x),3);
    bufp->chgCData(oldp+99,(vlSelf->ec_x),8);
    bufp->chgCData(oldp+100,(vlSelf->alu_fnselec),3);
    bufp->chgCData(oldp+101,(vlSelf->alu_a),4);
    bufp->chgCData(oldp+102,(vlSelf->alu_b),4);
    bufp->chgBit(oldp+103,(vlSelf->counter_EN));
    bufp->chgBit(oldp+104,(vlSelf->en));
    bufp->chgBit(oldp+105,(vlSelf->rand_in));
    bufp->chgBit(oldp+106,(vlSelf->state_machine_clr));
    bufp->chgBit(oldp+107,(vlSelf->ec_en));
    bufp->chgCData(oldp+108,(vlSelf->s),2);
    bufp->chgIData(oldp+109,(vlSelf->sft_rgtr_data),32);
    bufp->chgCData(oldp+110,(vlSelf->sft_rgtr_shamt),5);
    bufp->chgBit(oldp+111,(vlSelf->sft_rgtr_l_or_r));
    bufp->chgBit(oldp+112,(vlSelf->sft_rgtr_a_or_l));
    bufp->chgSData(oldp+113,(vlSelf->ledr),16);
    bufp->chgBit(oldp+114,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+115,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+116,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+117,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+118,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+119,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+120,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+121,(vlSelf->seg0),8);
    bufp->chgCData(oldp+122,(vlSelf->seg1),8);
    bufp->chgCData(oldp+123,(vlSelf->seg2),8);
    bufp->chgCData(oldp+124,(vlSelf->seg3),8);
    bufp->chgCData(oldp+125,(vlSelf->seg4),8);
    bufp->chgCData(oldp+126,(vlSelf->seg5),8);
    bufp->chgCData(oldp+127,(vlSelf->seg6),8);
    bufp->chgCData(oldp+128,(vlSelf->seg7),8);
    bufp->chgIData(oldp+129,(vlSelf->sft_out_q),32);
    bufp->chgCData(oldp+130,(vlSelf->y),2);
    bufp->chgCData(oldp+131,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+132,(vlSelf->y_dec),8);
    bufp->chgCData(oldp+133,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+134,(vlSelf->alu_zero));
    bufp->chgBit(oldp+135,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+136,(vlSelf->alu_carry));
    bufp->chgBit(oldp+137,(vlSelf->state_machine_out));
    bufp->chgCData(oldp+138,(vlSelf->inc_counter_out),8);
    bufp->chgCData(oldp+139,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+140,(vlSelf->timer_out));
    bufp->chgIData(oldp+141,(vlSelf->VGA_B),24);
    ...
    bufp->chgCData(oldp+147,(vlSelf->top__DOT__state_machine__DOT__state_din),4);
    bufp->chgCData(oldp+148,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__lut_out),4);
    bufp->chgBit(oldp+149,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__hit));
}
