...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+75,((0xffU & ((IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer) 
                                          >> 1U))),8);
        bufp->chgCData(oldp+76,(vlSelf->top__DOT__lookup__DOT__ascii),8);
        bufp->chgIData(oldp+77,(vlSelf->top__DOT__led1__DOT__count),32);
        bufp->chgCData(oldp+78,(vlSelf->top__DOT__led1__DOT__led),8);
        bufp->chgIData(oldp+79,(vlSelf->top__DOT__mu_seg__DOT__count),32);
        bufp->chgCData(oldp+80,(vlSelf->top__DOT__mu_seg__DOT__offset),3);
        bufp->chgIData(oldp+81,(vlSelf->top__DOT__mu_seg__DOT__x),32);
        bufp->chgSData(oldp+82,(vlSelf->top__DOT__my_keyboard__DOT__buffer),10);
        bufp->chgCData(oldp+83,(vlSelf->top__DOT__my_keyboard__DOT__count),4);
        bufp->chgCData(oldp+84,(vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync),3);
        bufp->chgBit(oldp+85,(vlSelf->top__DOT__my_keyboard__DOT__sampling));
        bufp->chgSData(oldp+86,(vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt),10);
        bufp->chgSData(oldp+87,(vlSelf->top__DOT__my_vga_ctrl__DOT__y_cnt),10);
        bufp->chgBit(oldp+88,(vlSelf->top__DOT__my_vga_ctrl__DOT__h_valid));
        bufp->chgBit(oldp+89,(vlSelf->top__DOT__my_vga_ctrl__DOT__v_valid));
        bufp->chgSData(oldp+90,(vlSelf->top__DOT____Vcellinp__my_vmem__v_addr),9);
        bufp->chgSData(oldp+91,(vlSelf->top__DOT__my_vmem__DOT__font_addr),12);
        bufp->chgSData(oldp+92,(vlSelf->top__DOT__my_vmem__DOT__word),12);
        bufp->chgSData(oldp+93,((0xfU & (IData)(vlSelf->top__DOT____Vcellinp__my_vmem__v_addr))),12);
        bufp->chgCData(oldp+94,((0xfU & VL_MODDIV_III(10, (IData)(vlSelf->top__DOT__h_addr), (IData)(9U)))),4);
        bufp->chgSData(oldp+95,(vlSelf->top__DOT__my_vmem__DOT__font_data),12);
        bufp->chgIData(oldp+96,(vlSelf->top__DOT__timer_1s__DOT__count_clk),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgCData(oldp+97,(vlSelf->top__DOT__state_machine__DOT__state_dout),4);
        bufp->chgBit(oldp+98,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__lut_out));
        bufp->chgBit(oldp+99,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__hit));
    }
    ...
    bufp->chgCData(oldp+154,(vlSelf->top__DOT__state_machine__DOT__state_din),4);
    bufp->chgCData(oldp+155,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__lut_out),4);
    bufp->chgBit(oldp+156,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__hit));
}
