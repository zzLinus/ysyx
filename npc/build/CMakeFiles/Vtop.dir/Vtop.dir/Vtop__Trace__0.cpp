...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgSData(oldp+90,(vlSelf->top__DOT__my_vmem__DOT__font_addr),12);
        bufp->chgSData(oldp+91,(vlSelf->top__DOT__my_vmem__DOT__word),12);
        bufp->chgSData(oldp+92,((0xfU & (IData)(vlSelf->top__DOT____Vcellinp__my_vmem__v_addr))),12);
        bufp->chgCData(oldp+93,((0xfU & VL_MODDIV_III(10, (IData)(vlSelf->top__DOT__h_addr), (IData)(9U)))),4);
        bufp->chgSData(oldp+94,(vlSelf->top__DOT__my_vmem__DOT__font_data),12);
        bufp->chgIData(oldp+95,(vlSelf->top__DOT__timer_1s__DOT__count_clk),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgCData(oldp+96,(vlSelf->top__DOT__state_machine__DOT__state_dout),4);
        bufp->chgBit(oldp+97,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__lut_out));
        bufp->chgBit(oldp+98,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__hit));
    }
    bufp->chgBit(oldp+99,(vlSelf->clk));
    bufp->chgBit(oldp+100,(vlSelf->rst));
    bufp->chgCData(oldp+101,(vlSelf->sw),8);
    bufp->chgBit(oldp+102,(vlSelf->ps2_clk));
    bufp->chgBit(oldp+103,(vlSelf->ps2_data));
    bufp->chgCData(oldp+104,(vlSelf->a),8);
    bufp->chgCData(oldp+105,(vlSelf->x),3);
    bufp->chgCData(oldp+106,(vlSelf->ec_x),8);
    bufp->chgCData(oldp+107,(vlSelf->alu_fnselec),3);
    bufp->chgCData(oldp+108,(vlSelf->alu_a),4);
    bufp->chgCData(oldp+109,(vlSelf->alu_b),4);
    bufp->chgBit(oldp+110,(vlSelf->counter_EN));
    bufp->chgBit(oldp+111,(vlSelf->en));
    bufp->chgBit(oldp+112,(vlSelf->rand_in));
    bufp->chgBit(oldp+113,(vlSelf->state_machine_clr));
    bufp->chgBit(oldp+114,(vlSelf->ec_en));
    bufp->chgCData(oldp+115,(vlSelf->s),2);
    bufp->chgIData(oldp+116,(vlSelf->sft_rgtr_data),32);
    bufp->chgCData(oldp+117,(vlSelf->sft_rgtr_shamt),5);
    bufp->chgBit(oldp+118,(vlSelf->sft_rgtr_l_or_r));
    bufp->chgBit(oldp+119,(vlSelf->sft_rgtr_a_or_l));
    bufp->chgSData(oldp+120,(vlSelf->ledr),16);
    bufp->chgBit(oldp+121,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+122,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+123,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+124,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+125,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+126,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+127,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+128,(vlSelf->seg0),8);
    bufp->chgCData(oldp+129,(vlSelf->seg1),8);
    bufp->chgCData(oldp+130,(vlSelf->seg2),8);
    bufp->chgCData(oldp+131,(vlSelf->seg3),8);
    bufp->chgCData(oldp+132,(vlSelf->seg4),8);
    bufp->chgCData(oldp+133,(vlSelf->seg5),8);
    bufp->chgCData(oldp+134,(vlSelf->seg6),8);
    bufp->chgCData(oldp+135,(vlSelf->seg7),8);
    bufp->chgIData(oldp+136,(vlSelf->sft_out_q),32);
    bufp->chgCData(oldp+137,(vlSelf->y),2);
    bufp->chgCData(oldp+138,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+139,(vlSelf->y_dec),8);
    bufp->chgCData(oldp+140,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+141,(vlSelf->alu_zero));
    bufp->chgBit(oldp+142,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+143,(vlSelf->alu_carry));
    bufp->chgBit(oldp+144,(vlSelf->state_machine_out));
    bufp->chgCData(oldp+145,(vlSelf->inc_counter_out),8);
    bufp->chgCData(oldp+146,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+147,(vlSelf->timer_out));
    bufp->chgCData(oldp+148,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+149,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+150,((0xfU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgCData(oldp+151,((0xfU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgBit(oldp+152,((1U & (~ (IData)(vlSelf->rst)))));
    bufp->chgCData(oldp+153,(vlSelf->top__DOT__state_machine__DOT__state_din),4);
    bufp->chgCData(oldp+154,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__lut_out),4);
    bufp->chgBit(oldp+155,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__hit));
}
