...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+32,(vlSelf->ledr),16);
    bufp->chgBit(oldp+33,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+34,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+35,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+36,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+37,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+38,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+39,(vlSelf->VGA_B),8);
    ...
    bufp->chgCData(oldp+46,(vlSelf->seg6),8);
    bufp->chgCData(oldp+47,(vlSelf->seg7),8);
    bufp->chgBit(oldp+48,(vlSelf->y));
    bufp->chgBit(oldp+49,((1U & (~ (IData)(vlSelf->rst)))));
}
