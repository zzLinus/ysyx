...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+108,(vlSelf->ec_en));
    bufp->chgCData(oldp+109,(vlSelf->s),2);
    bufp->chgIData(oldp+110,(vlSelf->sft_rgtr_data),32);
    bufp->chgCData(oldp+111,(vlSelf->sft_rgtr_shamt),5);
    bufp->chgBit(oldp+112,(vlSelf->sft_rgtr_l_or_r));
    bufp->chgBit(oldp+113,(vlSelf->sft_rgtr_a_or_l));
    bufp->chgSData(oldp+114,(vlSelf->ledr),16);
    bufp->chgBit(oldp+115,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+116,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+117,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+118,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+119,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+120,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+121,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+122,(vlSelf->seg0),8);
    bufp->chgCData(oldp+123,(vlSelf->seg1),8);
    bufp->chgCData(oldp+124,(vlSelf->seg2),8);
    bufp->chgCData(oldp+125,(vlSelf->seg3),8);
    bufp->chgCData(oldp+126,(vlSelf->seg4),8);
    bufp->chgCData(oldp+127,(vlSelf->seg5),8);
    bufp->chgCData(oldp+128,(vlSelf->seg6),8);
    bufp->chgCData(oldp+129,(vlSelf->seg7),8);
    bufp->chgIData(oldp+130,(vlSelf->sft_out_q),32);
    bufp->chgCData(oldp+131,(vlSelf->y),2);
    bufp->chgCData(oldp+132,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+133,(vlSelf->y_dec),8);
    bufp->chgCData(oldp+134,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+135,(vlSelf->alu_zero));
    bufp->chgBit(oldp+136,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+137,(vlSelf->alu_carry));
    bufp->chgBit(oldp+138,(vlSelf->state_machine_out));
    bufp->chgCData(oldp+139,(vlSelf->inc_counter_out),8);
    bufp->chgCData(oldp+140,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+141,(vlSelf->timer_out));
    bufp->chgCData(oldp+142,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+143,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+144,((0xfU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgCData(oldp+145,((0xfU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgBit(oldp+146,((1U & (~ (IData)(vlSelf->rst)))));
}
