...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+14,(vlSelf->top__DOT__counter__DOT__out_q),3);
        bufp->chgIData(oldp+15,(vlSelf->top__DOT__led1__DOT__count),32);
        bufp->chgCData(oldp+16,(vlSelf->top__DOT__led1__DOT__led),8);
        bufp->chgIData(oldp+17,(vlSelf->top__DOT__mu_seg__DOT__count),32);
        bufp->chgCData(oldp+18,(vlSelf->top__DOT__mu_seg__DOT__offset),3);
        bufp->chgIData(oldp+19,(vlSelf->top__DOT__mu_seg__DOT__x),32);
        bufp->chgSData(oldp+20,(vlSelf->top__DOT__my_keyboard__DOT__buffer),10);
        bufp->chgCData(oldp+21,(vlSelf->top__DOT__my_keyboard__DOT__count),4);
        bufp->chgCData(oldp+22,(vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync),3);
        bufp->chgBit(oldp+23,(vlSelf->top__DOT__my_keyboard__DOT__sampling));
        bufp->chgSData(oldp+24,(vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt),10);
        bufp->chgSData(oldp+25,(vlSelf->top__DOT__my_vga_ctrl__DOT__y_cnt),10);
        bufp->chgBit(oldp+26,(vlSelf->top__DOT__my_vga_ctrl__DOT__h_valid));
        bufp->chgBit(oldp+27,(vlSelf->top__DOT__my_vga_ctrl__DOT__v_valid));
        bufp->chgSData(oldp+28,((0x1ffU & (IData)(vlSelf->top__DOT__v_addr))),9);
    }
    ...
    bufp->chgBit(oldp+67,((1U & (~ (IData)(vlSelf->rst)))));
}
