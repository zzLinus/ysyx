...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+37,(vlSelf->top__DOT__alu__DOT__tmp),4);
        bufp->chgIData(oldp+38,(vlSelf->top__DOT__dec__DOT__i),32);
        bufp->chgIData(oldp+39,(vlSelf->top__DOT__encoder__DOT__i),32);
        bufp->chgCData(oldp+40,(vlSelf->top__DOT__state_machine__DOT__state_din),4);
        bufp->chgWData(oldp+41,(vlSelf->top__DOT__state_machine__DOT____Vcellinp__stateMux__lut),72);
        bufp->chgCData(oldp+44,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[0]),8);
        bufp->chgCData(oldp+45,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[1]),8);
        bufp->chgCData(oldp+46,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[2]),8);
        bufp->chgCData(oldp+47,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[3]),8);
        bufp->chgCData(oldp+48,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[4]),8);
        bufp->chgCData(oldp+49,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[5]),8);
        bufp->chgCData(oldp+50,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[6]),8);
        bufp->chgCData(oldp+51,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[7]),8);
        bufp->chgCData(oldp+52,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__pair_list[8]),8);
        bufp->chgCData(oldp+53,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[0]),4);
        bufp->chgCData(oldp+54,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[1]),4);
        bufp->chgCData(oldp+55,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[2]),4);
        bufp->chgCData(oldp+56,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[3]),4);
        bufp->chgCData(oldp+57,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[4]),4);
        bufp->chgCData(oldp+58,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[5]),4);
        bufp->chgCData(oldp+59,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[6]),4);
        bufp->chgCData(oldp+60,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[7]),4);
        bufp->chgCData(oldp+61,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__key_list[8]),4);
        ...
        bufp->chgCData(oldp+71,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__lut_out),4);
    ...
    bufp->chgCData(oldp+96,(vlSelf->sw),8);
    bufp->chgBit(oldp+97,(vlSelf->ps2_clk));
    bufp->chgBit(oldp+98,(vlSelf->ps2_data));
    bufp->chgCData(oldp+99,(vlSelf->a),8);
    bufp->chgCData(oldp+100,(vlSelf->x),3);
    bufp->chgCData(oldp+101,(vlSelf->ec_x),8);
    bufp->chgCData(oldp+102,(vlSelf->alu_fnselec),3);
    bufp->chgCData(oldp+103,(vlSelf->alu_a),4);
    bufp->chgCData(oldp+104,(vlSelf->alu_b),4);
    bufp->chgBit(oldp+105,(vlSelf->counter_EN));
    bufp->chgBit(oldp+106,(vlSelf->en));
    bufp->chgBit(oldp+107,(vlSelf->rand_in));
    bufp->chgBit(oldp+108,(vlSelf->state_machine_clr));
    bufp->chgBit(oldp+109,(vlSelf->ec_en));
    bufp->chgCData(oldp+110,(vlSelf->s),2);
    bufp->chgIData(oldp+111,(vlSelf->sft_rgtr_data),32);
    bufp->chgCData(oldp+112,(vlSelf->sft_rgtr_shamt),5);
    bufp->chgBit(oldp+113,(vlSelf->sft_rgtr_l_or_r));
    bufp->chgBit(oldp+114,(vlSelf->sft_rgtr_a_or_l));
    bufp->chgSData(oldp+115,(vlSelf->ledr),16);
    bufp->chgBit(oldp+116,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+117,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+118,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+119,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+120,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+121,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+122,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+123,(vlSelf->seg0),8);
    bufp->chgCData(oldp+124,(vlSelf->seg1),8);
    bufp->chgCData(oldp+125,(vlSelf->seg2),8);
    bufp->chgCData(oldp+126,(vlSelf->seg3),8);
    bufp->chgCData(oldp+127,(vlSelf->seg4),8);
    bufp->chgCData(oldp+128,(vlSelf->seg5),8);
    bufp->chgCData(oldp+129,(vlSelf->seg6),8);
    bufp->chgCData(oldp+130,(vlSelf->seg7),8);
    bufp->chgIData(oldp+131,(vlSelf->sft_out_q),32);
    bufp->chgCData(oldp+132,(vlSelf->y),2);
    bufp->chgCData(oldp+133,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+134,(vlSelf->y_dec),8);
    bufp->chgCData(oldp+135,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+136,(vlSelf->alu_zero));
    bufp->chgBit(oldp+137,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+138,(vlSelf->alu_carry));
    bufp->chgBit(oldp+139,(vlSelf->state_machine_out));
    bufp->chgCData(oldp+140,(vlSelf->inc_counter_out),8);
    bufp->chgCData(oldp+141,(vlSelf->dec_counter_out),3);
    bufp->chgBit(oldp+142,(vlSelf->timer_out));
    bufp->chgCData(oldp+143,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+144,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->chgCData(oldp+145,((0xfU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgCData(oldp+146,((0xfU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->chgBit(oldp+147,((1U & (~ (IData)(vlSelf->rst)))));
}
