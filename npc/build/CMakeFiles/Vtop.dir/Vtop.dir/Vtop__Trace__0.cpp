...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+8,(vlSelf->top__DOT__adder__DOT__tmp));
    ...
    bufp->chgBit(oldp+37,(vlSelf->alu_c));
    bufp->chgBit(oldp+38,(vlSelf->alu_a));
    bufp->chgBit(oldp+39,(vlSelf->alu_b));
    bufp->chgBit(oldp+40,(vlSelf->en));
    bufp->chgBit(oldp+41,(vlSelf->ec_en));
    bufp->chgCData(oldp+42,(vlSelf->s),2);
    bufp->chgSData(oldp+43,(vlSelf->ledr),16);
    bufp->chgBit(oldp+44,(vlSelf->VGA_CLK));
    bufp->chgBit(oldp+45,(vlSelf->VGA_HSYNC));
    bufp->chgBit(oldp+46,(vlSelf->VGA_VSYNC));
    bufp->chgBit(oldp+47,(vlSelf->VGA_BLANK_N));
    bufp->chgCData(oldp+48,(vlSelf->VGA_R),8);
    bufp->chgCData(oldp+49,(vlSelf->VGA_G),8);
    bufp->chgCData(oldp+50,(vlSelf->VGA_B),8);
    bufp->chgCData(oldp+51,(vlSelf->seg0),8);
    bufp->chgCData(oldp+52,(vlSelf->seg1),8);
    bufp->chgCData(oldp+53,(vlSelf->seg2),8);
    bufp->chgCData(oldp+54,(vlSelf->seg3),8);
    bufp->chgCData(oldp+55,(vlSelf->seg4),8);
    bufp->chgCData(oldp+56,(vlSelf->seg5),8);
    bufp->chgCData(oldp+57,(vlSelf->seg6),8);
    bufp->chgCData(oldp+58,(vlSelf->seg7),8);
    bufp->chgCData(oldp+59,(vlSelf->y),2);
    bufp->chgCData(oldp+60,(vlSelf->ec_y),3);
    bufp->chgCData(oldp+61,(vlSelf->y_dec),8);
    bufp->chgBit(oldp+62,(vlSelf->alu_s));
    bufp->chgBit(oldp+63,(vlSelf->alu_c_out));
