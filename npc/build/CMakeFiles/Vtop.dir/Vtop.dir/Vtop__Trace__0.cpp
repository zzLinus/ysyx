...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+74,((0xffU & ((IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer) 
                                          >> 1U))),8);
        ...
        bufp->chgSData(oldp+89,((0xfU & (IData)(vlSelf->top__DOT____Vcellinp__my_vmem__v_addr))),12);
        bufp->chgCData(oldp+90,((0xfU & VL_MODDIV_III(10, (IData)(vlSelf->top__DOT__h_addr), (IData)(9U)))),4);
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgIData(oldp+95,(((IData)(vlSelf->__VdfgTmp_h1c0fb021__0)
                                  ? 0xffffffU : 0U)),24);
        bufp->chgSData(oldp+96,(vlSelf->top__DOT__my_vmem__DOT__font_addr),12);
        bufp->chgSData(oldp+97,(vlSelf->top__DOT__my_vmem__DOT__word),12);
        bufp->chgSData(oldp+98,(vlSelf->top__DOT__my_vmem__DOT__font_data),12);
    }
