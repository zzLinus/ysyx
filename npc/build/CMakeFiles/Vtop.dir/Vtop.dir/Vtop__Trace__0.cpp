...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+88,(vlSelf->top__DOT__my_vmem__DOT__word),8);
        bufp->chgIData(oldp+89,(vlSelf->top__DOT__timer_1s__DOT__count_clk),32);
    }
    ...
    bufp->chgCData(oldp+95,(vlSelf->sw),8);
    bufp->chgBit(oldp+96,(vlSelf->ps2_clk));
    bufp->chgBit(oldp+97,(vlSelf->ps2_data));
    bufp->chgCData(oldp+98,(vlSelf->a),8);
    bufp->chgCData(oldp+99,(vlSelf->x),3);
    bufp->chgCData(oldp+100,(vlSelf->ec_x),8);
    bufp->chgCData(oldp+101,(vlSelf->alu_fnselec),3);
    bufp->chgCData(oldp+102,(vlSelf->alu_a),4);
    bufp->chgCData(oldp+103,(vlSelf->alu_b),4);
    bufp->chgBit(oldp+104,(vlSelf->counter_EN));
    bufp->chgBit(oldp+105,(vlSelf->en));
    bufp->chgBit(oldp+106,(vlSelf->rand_in));
    bufp->chgBit(oldp+107,(vlSelf->state_machine_clr));
