...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+62,(vlSelf->alu_res),4);
    bufp->chgBit(oldp+63,(vlSelf->alu_zero));
    bufp->chgBit(oldp+64,(vlSelf->alu_overflow));
    bufp->chgBit(oldp+65,(vlSelf->alu_carry));
    bufp->chgCData(oldp+66,(vlSelf->counter_out),3);
