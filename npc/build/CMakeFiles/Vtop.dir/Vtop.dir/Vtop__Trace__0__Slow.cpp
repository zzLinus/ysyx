...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+95,"sw", false,-1, 7,0);
    tracep->declBit(c+96,"ps2_clk", false,-1);
    tracep->declBit(c+97,"ps2_data", false,-1);
    tracep->declBus(c+98,"a", false,-1, 7,0);
    tracep->declBus(c+99,"x", false,-1, 2,0);
    tracep->declBus(c+100,"ec_x", false,-1, 7,0);
    tracep->declBus(c+101,"alu_fnselec", false,-1, 2,0);
    tracep->declBus(c+102,"alu_a", false,-1, 3,0);
    tracep->declBus(c+103,"alu_b", false,-1, 3,0);
    tracep->declBit(c+104,"counter_EN", false,-1);
    tracep->declBit(c+105,"en", false,-1);
    tracep->declBit(c+106,"rand_in", false,-1);
    tracep->declBit(c+107,"state_machine_clr", false,-1);
    tracep->declBit(c+108,"ec_en", false,-1);
    tracep->declBus(c+109,"s", false,-1, 1,0);
    tracep->declBus(c+110,"sft_rgtr_data", false,-1, 31,0);
    tracep->declBus(c+111,"sft_rgtr_shamt", false,-1, 4,0);
    tracep->declBit(c+112,"sft_rgtr_l_or_r", false,-1);
    tracep->declBit(c+113,"sft_rgtr_a_or_l", false,-1);
    tracep->declBus(c+114,"ledr", false,-1, 15,0);
    tracep->declBit(c+115,"VGA_CLK", false,-1);
    tracep->declBit(c+116,"VGA_HSYNC", false,-1);
    tracep->declBit(c+117,"VGA_VSYNC", false,-1);
    tracep->declBit(c+118,"VGA_BLANK_N", false,-1);
    tracep->declBus(c+119,"VGA_R", false,-1, 7,0);
    tracep->declBus(c+120,"VGA_G", false,-1, 7,0);
    tracep->declBus(c+121,"VGA_B", false,-1, 7,0);
    tracep->declBus(c+122,"seg0", false,-1, 7,0);
    tracep->declBus(c+123,"seg1", false,-1, 7,0);
    tracep->declBus(c+124,"seg2", false,-1, 7,0);
    tracep->declBus(c+125,"seg3", false,-1, 7,0);
    tracep->declBus(c+126,"seg4", false,-1, 7,0);
    tracep->declBus(c+127,"seg5", false,-1, 7,0);
    tracep->declBus(c+128,"seg6", false,-1, 7,0);
    tracep->declBus(c+129,"seg7", false,-1, 7,0);
    tracep->declBus(c+130,"sft_out_q", false,-1, 31,0);
    tracep->declBus(c+131,"y", false,-1, 1,0);
    tracep->declBus(c+132,"ec_y", false,-1, 2,0);
    tracep->declBus(c+133,"y_dec", false,-1, 7,0);
    tracep->declBus(c+134,"alu_res", false,-1, 3,0);
    tracep->declBit(c+135,"alu_zero", false,-1);
    tracep->declBit(c+136,"alu_overflow", false,-1);
    tracep->declBit(c+137,"alu_carry", false,-1);
    tracep->declBit(c+138,"state_machine_out", false,-1);
    tracep->declBus(c+139,"inc_counter_out", false,-1, 7,0);
    tracep->declBus(c+140,"dec_counter_out", false,-1, 2,0);
    tracep->declBit(c+141,"timer_out", false,-1);
    ...
    tracep->declBus(c+142,"vga_data", false,-1, 23,0);
    ...
    tracep->declBus(c+99,"x", false,-1, 2,0);
    tracep->declBit(c+105,"EN", false,-1);
    tracep->declBus(c+133,"y", false,-1, 7,0);
    ...
    tracep->declBus(c+140,"out_q", false,-1, 2,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("encoder ");
    tracep->declBus(c+100,"x", false,-1, 7,0);
    tracep->declBit(c+108,"EN", false,-1);
    tracep->declBus(c+132,"y", false,-1, 2,0);
    tracep->declBus(c+49,"i", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("inc_counter ");
    tracep->declBit(c+141,"clk", false,-1);
    tracep->declBit(c+104,"en", false,-1);
    tracep->declBus(c+139,"out_q", false,-1, 7,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+122,"o_seg0", false,-1, 7,0);
    tracep->declBus(c+123,"o_seg1", false,-1, 7,0);
    tracep->declBus(c+124,"o_seg2", false,-1, 7,0);
    tracep->declBus(c+125,"o_seg3", false,-1, 7,0);
    tracep->declBus(c+126,"o_seg4", false,-1, 7,0);
    tracep->declBus(c+127,"o_seg5", false,-1, 7,0);
    tracep->declBus(c+128,"o_seg6", false,-1, 7,0);
    tracep->declBus(c+129,"o_seg7", false,-1, 7,0);
    for (int i = 0; i < 10; ++i) {
        tracep->declBus(c+1+i*1,"segs", true,(i+0), 7,0);
    }
    tracep->declBus(c+151,"CLK_NUM", false,-1, 31,0);
    ...
    tracep->declBit(c+93,"pclk", false,-1);
    ...
    tracep->declBus(c+73,"font_h", false,-1, 5,0);
    tracep->declBus(c+74,"font_v", false,-1, 5,0);
    tracep->declBit(c+116,"hsync", false,-1);
    tracep->declBit(c+117,"vsync", false,-1);
    tracep->declBit(c+118,"valid", false,-1);
    tracep->declBus(c+119,"vga_r", false,-1, 7,0);
    tracep->declBus(c+120,"vga_g", false,-1, 7,0);
    tracep->declBus(c+121,"vga_b", false,-1, 7,0);
    tracep->declBus(c+152,"h_frontporch", false,-1, 31,0);
    tracep->declBus(c+153,"h_active", false,-1, 31,0);
    tracep->declBus(c+154,"h_backporch", false,-1, 31,0);
    tracep->declBus(c+155,"h_total", false,-1, 31,0);
    tracep->declBus(c+156,"v_frontporch", false,-1, 31,0);
    tracep->declBus(c+157,"v_active", false,-1, 31,0);
    tracep->declBus(c+158,"v_backporch", false,-1, 31,0);
    tracep->declBus(c+159,"v_total", false,-1, 31,0);
    ...
    tracep->declBus(c+74,"font_v", false,-1, 5,0);
    tracep->declBus(c+142,"vga_data", false,-1, 23,0);
    tracep->declBus(c+160,"word", false,-1, 9,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("sft_regstr ");
    tracep->declBus(c+110,"data", false,-1, 31,0);
    tracep->declBus(c+111,"shamt", false,-1, 4,0);
    tracep->declBit(c+112,"l_or_r", false,-1);
    tracep->declBit(c+113,"a_or_l", false,-1);
    tracep->declBus(c+130,"out_q", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+90,"state_dout", false,-1, 3,0);
    ...
    tracep->declBus(c+90,"key", false,-1, 3,0);
    ...
    tracep->declBit(c+107,"clr", false,-1);
    tracep->declBit(c+141,"clk", false,-1);
    tracep->declBus(c+148,"inp", false,-1, 3,0);
    tracep->declBus(c+90,"out_q", false,-1, 3,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+93,"clk", false,-1);
    tracep->declBit(c+141,"timer_out", false,-1);
    tracep->declBus(c+89,"count_clk", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+89,(vlSelf->top__DOT__timer_1s__DOT__count_clk),32);
    bufp->fullCData(oldp+90,(vlSelf->top__DOT__state_machine__DOT__state_dout),4);
    bufp->fullBit(oldp+91,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__lut_out));
    bufp->fullBit(oldp+92,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+93,(vlSelf->clk));
    bufp->fullBit(oldp+94,(vlSelf->rst));
    bufp->fullCData(oldp+95,(vlSelf->sw),8);
    bufp->fullBit(oldp+96,(vlSelf->ps2_clk));
    bufp->fullBit(oldp+97,(vlSelf->ps2_data));
    bufp->fullCData(oldp+98,(vlSelf->a),8);
    bufp->fullCData(oldp+99,(vlSelf->x),3);
    bufp->fullCData(oldp+100,(vlSelf->ec_x),8);
    bufp->fullCData(oldp+101,(vlSelf->alu_fnselec),3);
    bufp->fullCData(oldp+102,(vlSelf->alu_a),4);
    bufp->fullCData(oldp+103,(vlSelf->alu_b),4);
    bufp->fullBit(oldp+104,(vlSelf->counter_EN));
    bufp->fullBit(oldp+105,(vlSelf->en));
    bufp->fullBit(oldp+106,(vlSelf->rand_in));
    bufp->fullBit(oldp+107,(vlSelf->state_machine_clr));
    bufp->fullBit(oldp+108,(vlSelf->ec_en));
    bufp->fullCData(oldp+109,(vlSelf->s),2);
    bufp->fullIData(oldp+110,(vlSelf->sft_rgtr_data),32);
    bufp->fullCData(oldp+111,(vlSelf->sft_rgtr_shamt),5);
    bufp->fullBit(oldp+112,(vlSelf->sft_rgtr_l_or_r));
    bufp->fullBit(oldp+113,(vlSelf->sft_rgtr_a_or_l));
    bufp->fullSData(oldp+114,(vlSelf->ledr),16);
    bufp->fullBit(oldp+115,(vlSelf->VGA_CLK));
    bufp->fullBit(oldp+116,(vlSelf->VGA_HSYNC));
    bufp->fullBit(oldp+117,(vlSelf->VGA_VSYNC));
    bufp->fullBit(oldp+118,(vlSelf->VGA_BLANK_N));
    bufp->fullCData(oldp+119,(vlSelf->VGA_R),8);
    bufp->fullCData(oldp+120,(vlSelf->VGA_G),8);
    bufp->fullCData(oldp+121,(vlSelf->VGA_B),8);
    bufp->fullCData(oldp+122,(vlSelf->seg0),8);
    bufp->fullCData(oldp+123,(vlSelf->seg1),8);
    bufp->fullCData(oldp+124,(vlSelf->seg2),8);
    bufp->fullCData(oldp+125,(vlSelf->seg3),8);
    bufp->fullCData(oldp+126,(vlSelf->seg4),8);
    bufp->fullCData(oldp+127,(vlSelf->seg5),8);
    bufp->fullCData(oldp+128,(vlSelf->seg6),8);
    bufp->fullCData(oldp+129,(vlSelf->seg7),8);
    bufp->fullIData(oldp+130,(vlSelf->sft_out_q),32);
    bufp->fullCData(oldp+131,(vlSelf->y),2);
    bufp->fullCData(oldp+132,(vlSelf->ec_y),3);
    bufp->fullCData(oldp+133,(vlSelf->y_dec),8);
    bufp->fullCData(oldp+134,(vlSelf->alu_res),4);
    bufp->fullBit(oldp+135,(vlSelf->alu_zero));
    bufp->fullBit(oldp+136,(vlSelf->alu_overflow));
    bufp->fullBit(oldp+137,(vlSelf->alu_carry));
    bufp->fullBit(oldp+138,(vlSelf->state_machine_out));
    bufp->fullCData(oldp+139,(vlSelf->inc_counter_out),8);
    bufp->fullCData(oldp+140,(vlSelf->dec_counter_out),3);
    bufp->fullBit(oldp+141,(vlSelf->timer_out));
    bufp->fullIData(oldp+142,(vlSelf->VGA_B),24);
    ...
    bufp->fullIData(oldp+151,(0x4c4b40U),32);
    bufp->fullIData(oldp+152,(0x60U),32);
    bufp->fullIData(oldp+153,(0x90U),32);
    bufp->fullIData(oldp+154,(0x310U),32);
    bufp->fullIData(oldp+155,(0x320U),32);
    bufp->fullIData(oldp+156,(2U),32);
    bufp->fullIData(oldp+157,(0x23U),32);
    bufp->fullIData(oldp+158,(0x203U),32);
    bufp->fullIData(oldp+159,(0x20dU),32);
    bufp->fullSData(oldp+160,(vlSelf->top__DOT__my_vmem__DOT__word),10);
