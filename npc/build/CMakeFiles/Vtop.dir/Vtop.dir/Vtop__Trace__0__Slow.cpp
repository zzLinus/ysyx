...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+30,"ledr", false,-1, 15,0);
    ...
    tracep->declBit(c+25,"clk", false,-1);
    tracep->declBit(c+26,"rst", false,-1);
    tracep->declBus(c+38,"o_seg0", false,-1, 7,0);
    tracep->declBus(c+39,"o_seg1", false,-1, 7,0);
    tracep->declBus(c+40,"o_seg2", false,-1, 7,0);
    tracep->declBus(c+41,"o_seg3", false,-1, 7,0);
    tracep->declBus(c+42,"o_seg4", false,-1, 7,0);
    tracep->declBus(c+43,"o_seg5", false,-1, 7,0);
    tracep->declBus(c+44,"o_seg6", false,-1, 7,0);
    tracep->declBus(c+45,"o_seg7", false,-1, 7,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+1+i*1,"segs", true,(i+0), 7,0);
    }
    tracep->declBus(c+47,"CLK_NUM", false,-1, 31,0);
    tracep->declBus(c+14,"count", false,-1, 31,0);
    tracep->declBus(c+15,"offset", false,-1, 2,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("my_keyboard ");
    tracep->declBit(c+25,"clk", false,-1);
    tracep->declBit(c+46,"resetn", false,-1);
    tracep->declBit(c+28,"ps2_clk", false,-1);
    tracep->declBit(c+29,"ps2_data", false,-1);
    ...
    tracep->declBus(c+9,"h_addr", false,-1, 9,0);
    tracep->declBus(c+10,"v_addr", false,-1, 9,0);
    tracep->declBit(c+32,"hsync", false,-1);
    tracep->declBit(c+33,"vsync", false,-1);
    tracep->declBit(c+34,"valid", false,-1);
    tracep->declBus(c+35,"vga_r", false,-1, 7,0);
    tracep->declBus(c+36,"vga_g", false,-1, 7,0);
    tracep->declBus(c+37,"vga_b", false,-1, 7,0);
    tracep->declBus(c+48,"h_frontporch", false,-1, 31,0);
    tracep->declBus(c+49,"h_active", false,-1, 31,0);
    tracep->declBus(c+50,"h_backporch", false,-1, 31,0);
    tracep->declBus(c+51,"h_total", false,-1, 31,0);
    tracep->declBus(c+52,"v_frontporch", false,-1, 31,0);
    tracep->declBus(c+53,"v_active", false,-1, 31,0);
    tracep->declBus(c+54,"v_backporch", false,-1, 31,0);
    tracep->declBus(c+55,"v_total", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+30,(vlSelf->ledr),16);
    bufp->fullBit(oldp+31,(vlSelf->VGA_CLK));
    bufp->fullBit(oldp+32,(vlSelf->VGA_HSYNC));
    bufp->fullBit(oldp+33,(vlSelf->VGA_VSYNC));
    bufp->fullBit(oldp+34,(vlSelf->VGA_BLANK_N));
    bufp->fullCData(oldp+35,(vlSelf->VGA_R),8);
    bufp->fullCData(oldp+36,(vlSelf->VGA_G),8);
    bufp->fullCData(oldp+37,(vlSelf->VGA_B),8);
    ...
    bufp->fullBit(oldp+46,((1U & (~ (IData)(vlSelf->rst)))));
    bufp->fullIData(oldp+47,(0x4c4b40U),32);
    bufp->fullIData(oldp+48,(0x60U),32);
    bufp->fullIData(oldp+49,(0x90U),32);
    bufp->fullIData(oldp+50,(0x310U),32);
    bufp->fullIData(oldp+51,(0x320U),32);
    bufp->fullIData(oldp+52,(2U),32);
    bufp->fullIData(oldp+53,(0x23U),32);
    bufp->fullIData(oldp+54,(0x203U),32);
