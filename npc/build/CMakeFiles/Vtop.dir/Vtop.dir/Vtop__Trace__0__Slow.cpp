...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+47,"sft_rgtr_data", false,-1, 31,0);
    tracep->declBus(c+48,"sft_rgtr_shamt", false,-1, 4,0);
    tracep->declBit(c+49,"sft_rgtr_l_or_r", false,-1);
    tracep->declBit(c+50,"sft_rgtr_a_or_l", false,-1);
    tracep->declBus(c+51,"ledr", false,-1, 15,0);
    tracep->declBit(c+52,"VGA_CLK", false,-1);
    tracep->declBit(c+53,"VGA_HSYNC", false,-1);
    tracep->declBit(c+54,"VGA_VSYNC", false,-1);
    tracep->declBit(c+55,"VGA_BLANK_N", false,-1);
    tracep->declBus(c+56,"VGA_R", false,-1, 7,0);
    tracep->declBus(c+57,"VGA_G", false,-1, 7,0);
    tracep->declBus(c+58,"VGA_B", false,-1, 7,0);
    tracep->declBus(c+59,"seg0", false,-1, 7,0);
    tracep->declBus(c+60,"seg1", false,-1, 7,0);
    tracep->declBus(c+61,"seg2", false,-1, 7,0);
    tracep->declBus(c+62,"seg3", false,-1, 7,0);
    tracep->declBus(c+63,"seg4", false,-1, 7,0);
    tracep->declBus(c+64,"seg5", false,-1, 7,0);
    tracep->declBus(c+65,"seg6", false,-1, 7,0);
    tracep->declBus(c+66,"seg7", false,-1, 7,0);
    tracep->declBus(c+67,"sft_out_q", false,-1, 31,0);
    tracep->declBus(c+68,"y", false,-1, 1,0);
    tracep->declBus(c+69,"ec_y", false,-1, 2,0);
    tracep->declBus(c+70,"y_dec", false,-1, 7,0);
    tracep->declBus(c+71,"alu_res", false,-1, 3,0);
    tracep->declBit(c+72,"alu_zero", false,-1);
    tracep->declBit(c+73,"alu_overflow", false,-1);
    tracep->declBit(c+74,"alu_carry", false,-1);
    tracep->declBus(c+75,"inc_counter_out", false,-1, 7,0);
    tracep->declBus(c+76,"dec_counter_out", false,-1, 2,0);
    tracep->declBit(c+77,"timer_out", false,-1);
    ...
    tracep->declBus(c+78,"seg_x", false,-1, 7,0);
    tracep->declBus(c+79,"seg_y", false,-1, 7,0);
    ...
    tracep->declBus(c+38,"x", false,-1, 2,0);
    tracep->declBit(c+44,"EN", false,-1);
    tracep->declBus(c+70,"y", false,-1, 7,0);
    ...
    tracep->declBit(c+32,"clk", false,-1);
    tracep->declBit(c+33,"rst", false,-1);
    tracep->declBus(c+80,"seg_x", false,-1, 3,0);
    tracep->declBus(c+81,"seg_y", false,-1, 3,0);
    tracep->declBus(c+59,"o_seg0", false,-1, 7,0);
    tracep->declBus(c+60,"o_seg1", false,-1, 7,0);
    tracep->declBus(c+61,"o_seg2", false,-1, 7,0);
    tracep->declBus(c+62,"o_seg3", false,-1, 7,0);
    tracep->declBus(c+63,"o_seg4", false,-1, 7,0);
    tracep->declBus(c+64,"o_seg5", false,-1, 7,0);
    tracep->declBus(c+65,"o_seg6", false,-1, 7,0);
    tracep->declBus(c+66,"o_seg7", false,-1, 7,0);
    for (int i = 0; i < 10; ++i) {
        tracep->declBus(c+1+i*1,"segs", true,(i+0), 7,0);
    }
    tracep->declBus(c+83,"CLK_NUM", false,-1, 31,0);
    ...
    tracep->declBit(c+32,"clk", false,-1);
    tracep->declBit(c+82,"resetn", false,-1);
    tracep->declBit(c+35,"ps2_clk", false,-1);
    tracep->declBit(c+36,"ps2_data", false,-1);
    ...
    tracep->declBus(c+57,"vga_g", false,-1, 7,0);
    tracep->declBus(c+58,"vga_b", false,-1, 7,0);
    tracep->declBus(c+84,"h_frontporch", false,-1, 31,0);
    tracep->declBus(c+85,"h_active", false,-1, 31,0);
    tracep->declBus(c+86,"h_backporch", false,-1, 31,0);
    tracep->declBus(c+87,"h_total", false,-1, 31,0);
    tracep->declBus(c+88,"v_frontporch", false,-1, 31,0);
    tracep->declBus(c+89,"v_active", false,-1, 31,0);
    tracep->declBus(c+90,"v_backporch", false,-1, 31,0);
    tracep->declBus(c+91,"v_total", false,-1, 31,0);
    ...
    tracep->declBus(c+47,"data", false,-1, 31,0);
    tracep->declBus(c+48,"shamt", false,-1, 4,0);
    tracep->declBit(c+49,"l_or_r", false,-1);
    tracep->declBit(c+50,"a_or_l", false,-1);
    tracep->declBus(c+67,"out_q", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+47,(vlSelf->sft_rgtr_data),32);
    bufp->fullCData(oldp+48,(vlSelf->sft_rgtr_shamt),5);
    bufp->fullBit(oldp+49,(vlSelf->sft_rgtr_l_or_r));
    bufp->fullBit(oldp+50,(vlSelf->sft_rgtr_a_or_l));
    bufp->fullSData(oldp+51,(vlSelf->ledr),16);
    bufp->fullBit(oldp+52,(vlSelf->VGA_CLK));
    bufp->fullBit(oldp+53,(vlSelf->VGA_HSYNC));
    bufp->fullBit(oldp+54,(vlSelf->VGA_VSYNC));
    bufp->fullBit(oldp+55,(vlSelf->VGA_BLANK_N));
    bufp->fullCData(oldp+56,(vlSelf->VGA_R),8);
    bufp->fullCData(oldp+57,(vlSelf->VGA_G),8);
    bufp->fullCData(oldp+58,(vlSelf->VGA_B),8);
    bufp->fullCData(oldp+59,(vlSelf->seg0),8);
    bufp->fullCData(oldp+60,(vlSelf->seg1),8);
    bufp->fullCData(oldp+61,(vlSelf->seg2),8);
    bufp->fullCData(oldp+62,(vlSelf->seg3),8);
    bufp->fullCData(oldp+63,(vlSelf->seg4),8);
    bufp->fullCData(oldp+64,(vlSelf->seg5),8);
    bufp->fullCData(oldp+65,(vlSelf->seg6),8);
    bufp->fullCData(oldp+66,(vlSelf->seg7),8);
    bufp->fullIData(oldp+67,(vlSelf->sft_out_q),32);
    bufp->fullCData(oldp+68,(vlSelf->y),2);
    bufp->fullCData(oldp+69,(vlSelf->ec_y),3);
    bufp->fullCData(oldp+70,(vlSelf->y_dec),8);
    bufp->fullCData(oldp+71,(vlSelf->alu_res),4);
    bufp->fullBit(oldp+72,(vlSelf->alu_zero));
    bufp->fullBit(oldp+73,(vlSelf->alu_overflow));
    bufp->fullBit(oldp+74,(vlSelf->alu_carry));
    bufp->fullCData(oldp+75,(vlSelf->inc_counter_out),8);
    bufp->fullCData(oldp+76,(vlSelf->dec_counter_out),3);
    bufp->fullBit(oldp+77,(vlSelf->timer_out));
    bufp->fullCData(oldp+78,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->fullCData(oldp+79,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->fullCData(oldp+80,((0xfU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->fullCData(oldp+81,((0xfU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->fullBit(oldp+82,((1U & (~ (IData)(vlSelf->rst)))));
    bufp->fullIData(oldp+83,(0x4c4b40U),32);
    bufp->fullIData(oldp+84,(0x60U),32);
    bufp->fullIData(oldp+85,(0x90U),32);
    bufp->fullIData(oldp+86,(0x310U),32);
    bufp->fullIData(oldp+87,(0x320U),32);
    bufp->fullIData(oldp+88,(2U),32);
    bufp->fullIData(oldp+89,(0x23U),32);
    bufp->fullIData(oldp+90,(0x203U),32);
    bufp->fullIData(oldp+91,(0x20dU),32);
}
