...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+94,"sw", false,-1, 7,0);
    tracep->declBit(c+95,"ps2_clk", false,-1);
    tracep->declBit(c+96,"ps2_data", false,-1);
    tracep->declBus(c+97,"a", false,-1, 7,0);
    tracep->declBus(c+98,"x", false,-1, 2,0);
    tracep->declBus(c+99,"ec_x", false,-1, 7,0);
    tracep->declBus(c+100,"alu_fnselec", false,-1, 2,0);
    tracep->declBus(c+101,"alu_a", false,-1, 3,0);
    tracep->declBus(c+102,"alu_b", false,-1, 3,0);
    tracep->declBit(c+103,"counter_EN", false,-1);
    tracep->declBit(c+104,"en", false,-1);
    tracep->declBit(c+105,"rand_in", false,-1);
    tracep->declBit(c+106,"state_machine_clr", false,-1);
    tracep->declBit(c+107,"ec_en", false,-1);
    tracep->declBus(c+108,"s", false,-1, 1,0);
    tracep->declBus(c+109,"sft_rgtr_data", false,-1, 31,0);
    tracep->declBus(c+110,"sft_rgtr_shamt", false,-1, 4,0);
    tracep->declBit(c+111,"sft_rgtr_l_or_r", false,-1);
    tracep->declBit(c+112,"sft_rgtr_a_or_l", false,-1);
    tracep->declBus(c+113,"ledr", false,-1, 15,0);
    tracep->declBit(c+114,"VGA_CLK", false,-1);
    tracep->declBit(c+115,"VGA_HSYNC", false,-1);
    tracep->declBit(c+116,"VGA_VSYNC", false,-1);
    tracep->declBit(c+117,"VGA_BLANK_N", false,-1);
    tracep->declBus(c+118,"VGA_R", false,-1, 7,0);
    tracep->declBus(c+119,"VGA_G", false,-1, 7,0);
    tracep->declBus(c+120,"VGA_B", false,-1, 7,0);
    tracep->declBus(c+121,"seg0", false,-1, 7,0);
    tracep->declBus(c+122,"seg1", false,-1, 7,0);
    tracep->declBus(c+123,"seg2", false,-1, 7,0);
    tracep->declBus(c+124,"seg3", false,-1, 7,0);
    tracep->declBus(c+125,"seg4", false,-1, 7,0);
    tracep->declBus(c+126,"seg5", false,-1, 7,0);
    tracep->declBus(c+127,"seg6", false,-1, 7,0);
    tracep->declBus(c+128,"seg7", false,-1, 7,0);
    tracep->declBus(c+129,"sft_out_q", false,-1, 31,0);
    tracep->declBus(c+130,"y", false,-1, 1,0);
    tracep->declBus(c+131,"ec_y", false,-1, 2,0);
    tracep->declBus(c+132,"y_dec", false,-1, 7,0);
    tracep->declBus(c+133,"alu_res", false,-1, 3,0);
    tracep->declBit(c+134,"alu_zero", false,-1);
    tracep->declBit(c+135,"alu_overflow", false,-1);
    tracep->declBit(c+136,"alu_carry", false,-1);
    tracep->declBit(c+137,"state_machine_out", false,-1);
    tracep->declBus(c+138,"inc_counter_out", false,-1, 7,0);
    tracep->declBus(c+139,"dec_counter_out", false,-1, 2,0);
    tracep->declBit(c+140,"timer_out", false,-1);
    ...
    tracep->declBus(c+73,"vga_data", false,-1, 23,0);
    tracep->declBus(c+141,"seg_x", false,-1, 7,0);
    tracep->declBus(c+142,"seg_y", false,-1, 7,0);
    ...
    tracep->declBus(c+94,"sw", false,-1, 7,0);
    tracep->declBus(c+113,"ledr", false,-1, 15,0);
    tracep->declBus(c+74,"count", false,-1, 31,0);
    tracep->declBus(c+75,"led", false,-1, 7,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("mu_seg ");
    tracep->declBit(c+92,"clk", false,-1);
    tracep->declBit(c+93,"rst", false,-1);
    tracep->declBus(c+143,"seg_x", false,-1, 3,0);
    tracep->declBus(c+144,"seg_y", false,-1, 3,0);
    tracep->declBus(c+121,"o_seg0", false,-1, 7,0);
    tracep->declBus(c+122,"o_seg1", false,-1, 7,0);
    tracep->declBus(c+123,"o_seg2", false,-1, 7,0);
    tracep->declBus(c+124,"o_seg3", false,-1, 7,0);
    tracep->declBus(c+125,"o_seg4", false,-1, 7,0);
    tracep->declBus(c+126,"o_seg5", false,-1, 7,0);
    tracep->declBus(c+127,"o_seg6", false,-1, 7,0);
    tracep->declBus(c+128,"o_seg7", false,-1, 7,0);
    for (int i = 0; i < 10; ++i) {
        tracep->declBus(c+1+i*1,"segs", true,(i+0), 7,0);
    }
    tracep->declBus(c+149,"CLK_NUM", false,-1, 31,0);
    tracep->declBus(c+76,"count", false,-1, 31,0);
    tracep->declBus(c+77,"offset", false,-1, 2,0);
    tracep->declBus(c+78,"x", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+92,"clk", false,-1);
    tracep->declBit(c+145,"resetn", false,-1);
    tracep->declBit(c+95,"ps2_clk", false,-1);
    tracep->declBit(c+96,"ps2_data", false,-1);
    tracep->declBus(c+79,"buffer", false,-1, 9,0);
    tracep->declBus(c+80,"count", false,-1, 3,0);
    tracep->declBus(c+81,"ps2_clk_sync", false,-1, 2,0);
    tracep->declBit(c+82,"sampling", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("my_vga_ctrl ");
    tracep->declBit(c+92,"pclk", false,-1);
    tracep->declBit(c+93,"reset", false,-1);
    tracep->declBus(c+73,"vga_data", false,-1, 23,0);
    tracep->declBus(c+71,"h_addr", false,-1, 9,0);
    tracep->declBus(c+72,"v_addr", false,-1, 9,0);
    tracep->declBit(c+115,"hsync", false,-1);
    tracep->declBit(c+116,"vsync", false,-1);
    tracep->declBit(c+117,"valid", false,-1);
    tracep->declBus(c+118,"vga_r", false,-1, 7,0);
    tracep->declBus(c+119,"vga_g", false,-1, 7,0);
    tracep->declBus(c+120,"vga_b", false,-1, 7,0);
    tracep->declBus(c+150,"h_frontporch", false,-1, 31,0);
    tracep->declBus(c+151,"h_active", false,-1, 31,0);
    tracep->declBus(c+152,"h_backporch", false,-1, 31,0);
    tracep->declBus(c+153,"h_total", false,-1, 31,0);
    tracep->declBus(c+154,"v_frontporch", false,-1, 31,0);
    tracep->declBus(c+155,"v_active", false,-1, 31,0);
    tracep->declBus(c+156,"v_backporch", false,-1, 31,0);
    tracep->declBus(c+157,"v_total", false,-1, 31,0);
    tracep->declBus(c+83,"x_cnt", false,-1, 9,0);
    tracep->declBus(c+84,"y_cnt", false,-1, 9,0);
    tracep->declBit(c+85,"h_valid", false,-1);
    tracep->declBit(c+86,"v_valid", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("my_vmem ");
    tracep->declBus(c+71,"h_addr", false,-1, 9,0);
    tracep->declBus(c+87,"v_addr", false,-1, 8,0);
    tracep->declBus(c+73,"vga_data", false,-1, 23,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("sft_regstr ");
    tracep->declBus(c+109,"data", false,-1, 31,0);
    tracep->declBus(c+110,"shamt", false,-1, 4,0);
    tracep->declBit(c+111,"l_or_r", false,-1);
    tracep->declBit(c+112,"a_or_l", false,-1);
    tracep->declBus(c+129,"out_q", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("state_machine ");
    tracep->declBit(c+140,"clk", false,-1);
    tracep->declBit(c+105,"in", false,-1);
    ...
    tracep->declBus(c+146,"state_din", false,-1, 3,0);
    tracep->declBus(c+89,"state_dout", false,-1, 3,0);
    tracep->pushNamePrefix("outMux ");
    tracep->declBus(c+167,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+168,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+169,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+137,"out", false,-1, 0,0);
    tracep->declBus(c+89,"key", false,-1, 3,0);
    tracep->declBus(c+170,"default_out", false,-1, 0,0);
    tracep->declQuad(c+171,"lut", false,-1, 44,0);
    ...
    tracep->declBus(c+168,"BITS", false,-1, 31,0);
    tracep->declBit(c+140,"load", false,-1);
    tracep->declBit(c+106,"clr", false,-1);
    tracep->declBit(c+140,"clk", false,-1);
    tracep->declBus(c+146,"inp", false,-1, 3,0);
    tracep->declBus(c+89,"out_q", false,-1, 3,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("stateMux ");
    tracep->declBus(c+167,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+168,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+168,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+146,"out", false,-1, 3,0);
    tracep->declBus(c+89,"key", false,-1, 3,0);
    ...
    tracep->declBus(c+147,"lut_out", false,-1, 3,0);
    ...
    tracep->declBit(c+92,"clk", false,-1);
    tracep->declBit(c+140,"timer_out", false,-1);
    tracep->declBus(c+88,"count_clk", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+73,(vlSelf->top__DOT__vga_data),24);
    bufp->fullIData(oldp+74,(vlSelf->top__DOT__led1__DOT__count),32);
    bufp->fullCData(oldp+75,(vlSelf->top__DOT__led1__DOT__led),8);
    bufp->fullIData(oldp+76,(vlSelf->top__DOT__mu_seg__DOT__count),32);
    bufp->fullCData(oldp+77,(vlSelf->top__DOT__mu_seg__DOT__offset),3);
    bufp->fullIData(oldp+78,(vlSelf->top__DOT__mu_seg__DOT__x),32);
    bufp->fullSData(oldp+79,(vlSelf->top__DOT__my_keyboard__DOT__buffer),10);
    bufp->fullCData(oldp+80,(vlSelf->top__DOT__my_keyboard__DOT__count),4);
    bufp->fullCData(oldp+81,(vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync),3);
    bufp->fullBit(oldp+82,(vlSelf->top__DOT__my_keyboard__DOT__sampling));
    bufp->fullSData(oldp+83,(vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt),10);
    bufp->fullSData(oldp+84,(vlSelf->top__DOT__my_vga_ctrl__DOT__y_cnt),10);
    bufp->fullBit(oldp+85,(vlSelf->top__DOT__my_vga_ctrl__DOT__h_valid));
    bufp->fullBit(oldp+86,(vlSelf->top__DOT__my_vga_ctrl__DOT__v_valid));
    bufp->fullSData(oldp+87,(vlSelf->top__DOT____Vcellinp__my_vmem__v_addr),9);
    bufp->fullIData(oldp+88,(vlSelf->top__DOT__timer_1s__DOT__count_clk),32);
    bufp->fullCData(oldp+89,(vlSelf->top__DOT__state_machine__DOT__state_dout),4);
    bufp->fullBit(oldp+90,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__lut_out));
    bufp->fullBit(oldp+91,(vlSelf->top__DOT__state_machine__DOT__outMux__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+92,(vlSelf->clk));
    bufp->fullBit(oldp+93,(vlSelf->rst));
    bufp->fullCData(oldp+94,(vlSelf->sw),8);
    bufp->fullBit(oldp+95,(vlSelf->ps2_clk));
    bufp->fullBit(oldp+96,(vlSelf->ps2_data));
    bufp->fullCData(oldp+97,(vlSelf->a),8);
    bufp->fullCData(oldp+98,(vlSelf->x),3);
    bufp->fullCData(oldp+99,(vlSelf->ec_x),8);
    bufp->fullCData(oldp+100,(vlSelf->alu_fnselec),3);
    bufp->fullCData(oldp+101,(vlSelf->alu_a),4);
    bufp->fullCData(oldp+102,(vlSelf->alu_b),4);
    bufp->fullBit(oldp+103,(vlSelf->counter_EN));
    bufp->fullBit(oldp+104,(vlSelf->en));
    bufp->fullBit(oldp+105,(vlSelf->rand_in));
    bufp->fullBit(oldp+106,(vlSelf->state_machine_clr));
    bufp->fullBit(oldp+107,(vlSelf->ec_en));
    bufp->fullCData(oldp+108,(vlSelf->s),2);
    bufp->fullIData(oldp+109,(vlSelf->sft_rgtr_data),32);
    bufp->fullCData(oldp+110,(vlSelf->sft_rgtr_shamt),5);
    bufp->fullBit(oldp+111,(vlSelf->sft_rgtr_l_or_r));
    bufp->fullBit(oldp+112,(vlSelf->sft_rgtr_a_or_l));
    bufp->fullSData(oldp+113,(vlSelf->ledr),16);
    bufp->fullBit(oldp+114,(vlSelf->VGA_CLK));
    bufp->fullBit(oldp+115,(vlSelf->VGA_HSYNC));
    bufp->fullBit(oldp+116,(vlSelf->VGA_VSYNC));
    bufp->fullBit(oldp+117,(vlSelf->VGA_BLANK_N));
    bufp->fullCData(oldp+118,(vlSelf->VGA_R),8);
    bufp->fullCData(oldp+119,(vlSelf->VGA_G),8);
    bufp->fullCData(oldp+120,(vlSelf->VGA_B),8);
    bufp->fullCData(oldp+121,(vlSelf->seg0),8);
    bufp->fullCData(oldp+122,(vlSelf->seg1),8);
    bufp->fullCData(oldp+123,(vlSelf->seg2),8);
    bufp->fullCData(oldp+124,(vlSelf->seg3),8);
    bufp->fullCData(oldp+125,(vlSelf->seg4),8);
    bufp->fullCData(oldp+126,(vlSelf->seg5),8);
    bufp->fullCData(oldp+127,(vlSelf->seg6),8);
    bufp->fullCData(oldp+128,(vlSelf->seg7),8);
    bufp->fullIData(oldp+129,(vlSelf->sft_out_q),32);
    bufp->fullCData(oldp+130,(vlSelf->y),2);
    bufp->fullCData(oldp+131,(vlSelf->ec_y),3);
    bufp->fullCData(oldp+132,(vlSelf->y_dec),8);
    bufp->fullCData(oldp+133,(vlSelf->alu_res),4);
    bufp->fullBit(oldp+134,(vlSelf->alu_zero));
    bufp->fullBit(oldp+135,(vlSelf->alu_overflow));
    bufp->fullBit(oldp+136,(vlSelf->alu_carry));
    bufp->fullBit(oldp+137,(vlSelf->state_machine_out));
    bufp->fullCData(oldp+138,(vlSelf->inc_counter_out),8);
    bufp->fullCData(oldp+139,(vlSelf->dec_counter_out),3);
    bufp->fullBit(oldp+140,(vlSelf->timer_out));
    bufp->fullCData(oldp+141,((0xffU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->fullCData(oldp+142,((0xffU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),8);
    bufp->fullCData(oldp+143,((0xfU & VL_MODDIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->fullCData(oldp+144,((0xfU & VL_DIV_III(32, (IData)(vlSelf->inc_counter_out), (IData)(0xaU)))),4);
    bufp->fullBit(oldp+145,((1U & (~ (IData)(vlSelf->rst)))));
    bufp->fullCData(oldp+146,(vlSelf->top__DOT__state_machine__DOT__state_din),4);
    bufp->fullCData(oldp+147,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__lut_out),4);
    bufp->fullBit(oldp+148,(vlSelf->top__DOT__state_machine__DOT__stateMux__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+149,(0x4c4b40U),32);
    bufp->fullIData(oldp+150,(0x60U),32);
    bufp->fullIData(oldp+151,(0x90U),32);
    bufp->fullIData(oldp+152,(0x310U),32);
    bufp->fullIData(oldp+153,(0x320U),32);
    bufp->fullIData(oldp+154,(2U),32);
    bufp->fullIData(oldp+155,(0x23U),32);
    bufp->fullIData(oldp+156,(0x203U),32);
    bufp->fullIData(oldp+157,(0x20dU),32);
