...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge timer_out)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge timer_out)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 49152; ++__Vi0) {
    ...
    vlSelf->top__DOT__my_vmem__DOT__word = VL_RAND_RESET_I(16);
    ...
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__font_addr = VL_RAND_RESET_I(16);
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__word = VL_RAND_RESET_I(16);
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__font_cord_v = VL_RAND_RESET_I(16);
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__font_cord_h = VL_RAND_RESET_I(16);
