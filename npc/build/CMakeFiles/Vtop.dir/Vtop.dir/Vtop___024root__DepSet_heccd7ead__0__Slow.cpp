...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 49151; ++__Vi0) {
        vlSelf->top__DOT__my_vmem__DOT__font_rom[__Vi0] = VL_RAND_RESET_I(1);
    }
    vlSelf->top__DOT__my_vmem__DOT__font_addr = VL_RAND_RESET_I(20);
    vlSelf->top__DOT__my_vmem__DOT__word = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__my_vmem__DOT__font_cord_v = VL_RAND_RESET_I(6);
    ...
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__font_addr = VL_RAND_RESET_I(20);
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__word = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__font_cord_v = VL_RAND_RESET_I(6);
    vlSelf->top__DOT__my_vmem__DOT____Vtogcov__font_cord_h = VL_RAND_RESET_I(6);
