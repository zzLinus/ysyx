...
VL_ATTR_COLD void Vour___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vour___024root__trace_register(Vour___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->addFullCb(&Vour___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vour___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vour___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vour___024root__trace_full_sub_0(Vour___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vour___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour___024root__trace_full_top_0\n"); );
    // Init
    Vour___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vour___024root*>(voidSelf);
    Vour__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vour___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vour___024root__trace_full_sub_0(Vour___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vour__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour___024root__trace_full_sub_0\n"); );
    // Init
