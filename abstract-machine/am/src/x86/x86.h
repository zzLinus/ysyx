...
#define SEG16(type, base, lim, dpl)                                                                  \
    (SegDesc)                                                                                        \
    {                                                                                                \
        (lim) & 0xffff, (uintptr_t)(base)&0xffff, ((uintptr_t)(base) >> 16) & 0xff, type, 0, dpl, 1, \
...
#define SEG32(type, base, lim, dpl)                                                                          \
    (SegDesc)                                                                                                \
    {                                                                                                        \
        ((lim) >> 12) & 0xffff, (uintptr_t)(base)&0xffff, ((uintptr_t)(base) >> 16) & 0xff, type, 1, dpl, 1, \
...
#define SEGTSS64(type, base, lim, dpl)                                                                                    \
    (SegDesc)                                                                                                             \
    {                                                                                                                     \
        (lim) & 0xffff, (uint32_t)(base)&0xffff, ((uint32_t)(base) >> 16) & 0xff, type, 0, dpl, 1, (uint32_t)(lim) >> 16, \
            0, 0, 0, 0, (uint32_t)(base) >> 24                                                                            \
    }
...
#define GATE64(type, cs, entry, dpl)                                                                     \
    (GateDesc64)                                                                                         \
    {                                                                                                    \
        (uint64_t)(entry) & 0xffff, (cs), 0, 0, (type), 0, (dpl), 1, ((uint64_t)(entry) >> 16) & 0xffff, \
            (uint64_t)(entry) >> 32, 0                                                                   \
    }
